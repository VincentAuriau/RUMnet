...
def data_expedia_woopt(path_to_data="./data/expedia/", perm=1):
    """
    Takes wide data (normalized) and returns list of product features, separate from customers'
    """
    raw_data = np.load(os.path.join(path_to_data, "data_without_outside_opt/X_matrix.npy"))
    raw_target = np.load(os.path.join(path_to_data, "data_without_outside_opt/Y_matrix.npy"))
...
def data_expedia_opt(path_to_data="./data/expedia", perm=1):
    """
    Takes wide data (normalized) and returns list of product features, separate from customers'
    """
    raw_data = np.load(os.path.join(path_to_data, "data_with_outside_opt/X_matrix.npy"))
    raw_target = np.load(os.path.join(path_to_data, "data_with_outside_opt/Y_matrix.npy"))
